  ...
  it("parses commit metadata from a single-object pack", () => {
    const pack = buildSingleObjectPack(
      ...
      [
        ...
        "committer C <c@example.com> 1700001234 +0000",
        "",
  ...
  it("parses annotated tag metadata from a single-object pack", () => {
    const pack = buildSingleObjectPack(
      ...
      [
        ...
        "type commit",
        "tag v1.0.0",
        "tagger T <t@example.com> 1700004321 +0000",
        "",
    ...
    const pack = buildPack([
      {
        ...
        text: [
          "tree 0000000000000000000000000000000000000000",
          "committer C <c@example.com> 1700002222 +0000",
          "",
      ...
      },
      {
        ...
        text: [
          ...
          "type commit",
          "tag v2.0.0",
          "tagger T <t@example.com> 1700003333 +0000",
          "",
