...
describe('getLatestReleasesForRepos invalid url path', () => {
  it('marks repo with error invalid_url when not github.com', async () => {
    ...
    const settings: AppSettings = { timeFormat: '24h', locale: 'en', refreshInterval: 10, cacheInterval: 0, releasesPerPage: 30, parallelRepoFetches: 5, releaseChannels: ['stable'] } as any;
