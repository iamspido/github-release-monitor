...
- **Internationalization (i18n)**: Supports English, German, French, Spanish,
  ...
  Korean, Turkish, Vietnamese, Italian, Polish, Ukrainian, and Arabic out of
  the box, including right-to-left layout.
...
Italian (`it`), Indonesian (`id`), and Polish (`pl`) use the existing Inter
profile.
